...
PERSONA padre ON PERSONA.Grupo_Familiar_ID_Grupo_Familiar = padre.Grupo_Familiar_ID_Grupo_Familiar RIGHT OUTER JOIN
PERSONA madre ON PERSONA.Grupo_Familiar_ID_Grupo_Familiar = madre.Grupo_Familiar_ID_Grupo_Familiar
WHERE 
(
madre.Tipo_Persona_Id_Tipo_Persona = 12 or
madre.Tipo_Persona_Id_Tipo_Persona = 4 or 
madre.Tipo_Persona_Id_Tipo_Persona = 8 or 
madre.Tipo_Persona_Id_Tipo_Persona = 6 or
madre.Tipo_Persona_Id_Tipo_Persona = 7 
) and
