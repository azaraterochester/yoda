...
WHERE (madre.Tipo_Persona_Id_Tipo_Persona = 12 OR madre.Tipo_Persona_Id_Tipo_Persona = 4 OR madre.Tipo_Persona_Id_Tipo_Persona = 11 OR madre.Tipo_Persona_Id_Tipo_Persona = 10)
