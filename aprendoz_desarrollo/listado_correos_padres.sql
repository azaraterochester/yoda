...
WHERE (padre.Tipo_Persona_Id_Tipo_Persona = 2 or padre.Tipo_Persona_Id_Tipo_Persona = 10 or padre.Tipo_Persona_Id_Tipo_Persona = 4 or padre.Tipo_Persona_Id_Tipo_Persona = 8) AND alum.Tipo_Persona_Id_Tipo_Persona = 1 AND Insc_Alum_Curso.SY_Id_SY = 3 AND Curso.Id_Curso >= 10101 
