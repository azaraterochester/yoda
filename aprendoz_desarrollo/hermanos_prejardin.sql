...
WHERE grupo_familiar_prejardin(Grupo_Familiar.ID_Grupo_Familiar) = 1 and (curso_actual(PERSONA.Id_Persona,3) = 0 OR curso_actual(PERSONA.Id_Persona,3) >= 10101 and curso_actual(PERSONA.Id_Persona,3) <= 40403 ) and ipg.Tipo_Persona_Id_Tipo_Persona = 1